...
for package in packages
  ...
  when :octo
    ...
    plugin_path = nil
    if mode == "debug"
      plugin_path = File.join(Dir.pwd, ".build/Plugins/debug/")
    else
      raise "plugin_path is unimplented for release mode"
    end
    plugin_path_file = <<-EOF
// This file is generated by `build.rb`
import Foundation

let PLUGIN_PATH = URL(filePath: "#{plugin_path}").resolvingSymlinksInPath()
    EOF
